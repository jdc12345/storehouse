...
@interface MineApplyDetailVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation MineApplyDetailVC
...
-(void)setModel:(LaunchListModel *)model{
    _model = model;
